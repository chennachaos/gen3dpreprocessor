...
! the size limitations for the agglomerator
    ...
    integer :: VISOUTFILE,COMPOUTFILE  ! visualization and calculation output files 
...
! this is first transformed into a side-based structure.
  ...
  if (inputNumber.le.9) then
    ...
    itForm ='(i3)'
    itLen = 3
  else if (inputNumber.le.9999) then
    itForm ='(i4)'
    itLen = 4
  endif
...
!MOVE
  ...
  if(inputNumber2.le.9) then
    ...
    itForm2 ='(i3)'
    itLen2 = 3
  else if (inputNumber2.le.9999) then
    itForm2 ='(i4)'
    itLen2 = 4
  endif
